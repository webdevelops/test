...
const phonesURL = 'https://quick-shop-1.firebaseio.com/phones/.json';
const categoriesURL = 'https://quick-shop-1.firebaseio.com/categories/.json';

const key = 'AIzaSyBR9ffOpJ-ulXF7BROSM6Btv-ULieSizF4';
...
const sendDataToServer = async (url, data) => {
  try {
    ...
    console.log("sendDataToDerver -> json", json)
  } catch (err) {
...
export const sendCategoriesToServer = async () => {
  return await sendDataToServer(categoriesURL, categories);
};
