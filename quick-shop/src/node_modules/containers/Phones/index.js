...
const Phones = ({ 
  ...
  const renderPhone = (phone, index) => {
    return (
      <Grid item xs={10} sm={6} lg={4} key={index} className={classes.card}>
  ...
  return (
    <div className={classes.root}>
      <Grid container justify="space-between">
        <Grid container item md={4} md={4} lg={3} className={classes.sidebar}>
          <BasketCart />
          <Search />
        ...
        <Fragment>
          <Grid container item md={8} md={8} lg={9} spacing={4} className={classes.content}>
